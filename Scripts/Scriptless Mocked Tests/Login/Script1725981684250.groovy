...
WebUI.click(findTestObject('Scriptless Mocked Objects/Login/Page_CURA Healthcare Service/i_CURA Healthcare_fa fa-bars'))

WebUI.click(findTestObject('Scriptless Mocked Objects/Login/Page_CURA Healthcare Service/a_Login'))
...
WebUI.click(findTestObject('Scriptless Mocked Objects/Login/Page_CURA Healthcare Service/a_Logout'))
